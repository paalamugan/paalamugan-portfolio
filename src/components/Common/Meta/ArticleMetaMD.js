...
const ArticleMetaMD = ({ data, canonical }) => {
    ...
    const publishedAtISODate = fm.date ? new Date(fm.date).toISOString() : new Date(`2021-03-20`).toISOString()
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="article:author" content="https://www.facebook.com/paalamugan/" />
